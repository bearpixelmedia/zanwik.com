    ...
    try {
      ...
      if (data.success) {
        const projects = data.data.filter(
          p => p.status === 'live' && p.revenue.current > 0,
        );
      ...
      <section className='text-center py-16 bg-gradient-to-br from-blue-50 to-purple-50'>
        <div className='max-w-4xl mx-auto px-4'>
          ...
          <p className='text-xl text-gray-600 mb-8'>
            Discover, integrate, and monetize APIs to build profitable online
            businesses. Track your projects, monitor API health, and scale your
            revenue.
          </p>
        ...
        <div className='max-w-6xl mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600'>
              From discovery to deployment, we provide the tools entrepreneurs
              need to succeed
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <Card className='p-6 text-center'>
              ...
              <p className='text-gray-600'>
                Find the perfect APIs for your business with advanced search,
            ...
            <Card className='p-6 text-center'>
              ...
              <p className='text-gray-600'>
                Track your business projects, monitor API usage, and measure
            ...
            <Card className='p-6 text-center'>
              ...
              <p className='text-gray-600'>
                Test APIs before integration with built-in testing tools and
      ...
      <section className='py-16'>
        <div className='max-w-6xl mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600'>
              Start building with these high-quality APIs trusted by successful
              businesses
            </p>
          </div>
      ...
      <section className='py-16 bg-gray-50'>
        <div className='max-w-6xl mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600'>
              See how entrepreneurs are building profitable businesses with our
              APIs
            </p>
          </div>
      ...
      <section className='py-16 bg-blue-600 text-white'>
        <div className='max-w-4xl mx-auto px-4 text-center'>
          ...
          <p className='text-xl mb-8 opacity-90'>
            Join thousands of entrepreneurs who are already building profitable
            businesses with our APIs
          </p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            <div>
              ...
              <p className='text-gray-400'>
                The API Directory for Entrepreneurs. Build, scale, and monetize
