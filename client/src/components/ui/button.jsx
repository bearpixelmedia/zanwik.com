      ...
      <>
        ...
        {isLoading && (
          <div className='absolute inset-0 flex items-center justify-center bg-inherit rounded-inherit'>
            <Loader2
              className={cn('animate-spin', getLoadingIconSizeClass())}
            />
          </div>
        )}
        ...
        >
          ...
          {isLoading && iconPosition === 'left' && (
            <Loader2
              className={cn('mr-2 animate-spin', getLoadingIconSizeClass())}
            />
          )}
          ...
          {isLoading && iconPosition === 'right' && (
            <Loader2
              className={cn('ml-2 animate-spin', getLoadingIconSizeClass())}
            />
          )}
        </div>
