    ...
    const sampleNotifications = [
      {
        ...
        message: 'Project "E-commerce App" has been deployed successfully to production.',
        time: '2 minutes ago',
        read: false,
        icon: CheckCircle
      },
      {
        ...
        message: 'Server CPU usage is at 85%. Consider scaling your infrastructure.',
        time: '15 minutes ago',
        read: false,
        icon: AlertTriangle
      },
      ...
      },
      {
        ...
        message: 'Unable to connect to the primary database. Check your configuration.',
        time: '2 hours ago',
        read: false,
        icon: AlertCircle
      }
        ...
        <div className="flex items-center space-x-3">
          ...
          {sessionWarning && (
            <div className="flex items-center space-x-2 px-3 py-1 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
              ...
              <span className="text-xs text-yellow-600 font-medium">Session expires soon</span>
              <Button
                variant="ghost"
                size="sm"
