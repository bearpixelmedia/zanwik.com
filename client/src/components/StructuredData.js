    ...
    switch (type) {
      ...
      case 'organization':
        return {
          ...
          description:
            'The API directory for entrepreneurs and developers. Discover, test, and integrate APIs with confidence.',
          foundingDate: '2024',
          contactPoint: {
            '@type': 'ContactPoint',
          ...
          sameAs: ['https://github.com/zanwik', 'https://twitter.com/zanwik'],
        };
