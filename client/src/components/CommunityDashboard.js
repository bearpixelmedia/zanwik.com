  ...
  const loadCommunityData = async () => {
    try {
      ...
      if (submissionsData.success)
        setRecentSubmissions(submissionsData.data.slice(0, 5));
    ...
    <div className='space-y-6'>
      ...
      <div>
        ...
        <p className='text-gray-600'>
          Welcome to the Zanwik developer community
        </p>
      </div>
              ...
              >
                <div className='flex-1'>
                  ...
                  <div className='text-sm text-gray-600'>
                    {submission.apiData.description}
                  </div>
                  <div className='flex items-center space-x-2 mt-1'>
                    <span className='text-xs text-gray-500'>
                      {submission.apiData.category}
                    </span>
              ...
              <div className='flex items-center space-x-3'>
                ...
                <div>
                  ...
                  <div className='text-sm text-gray-600'>
                    ...
                    {contributor.reviews} reviews • {contributor.posts} posts
                  </div>
                </div>
              </div>
