        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
          ...
          <Card className='p-4'>
            <div className='text-2xl font-bold text-orange-600'>
              {revenueData.totalSubscriptions}
            </div>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        {revenueData && (
          <Card className='p-6'>
            ...
            <div className='space-y-4'>
              {Object.entries(revenueData.byFeature).map(
                ([featureId, amount]) => (
                  <div
                    key={featureId}
                  ...
                  >
                    <div className='flex items-center space-x-3'>
                      ...
                      <span className='text-sm text-gray-600'>
                        {subscriptionStats?.byFeature?.[featureId] || 0}{' '}
                        subscriptions
                      </span>
                    </div>
                    <div className='text-sm font-medium'>
            ...
            <div className='text-center'>
              <div className='text-2xl font-bold text-purple-600'>
                {subscriptionStats.total > 0
                  ? Math.round(
                      (subscriptionStats.active / subscriptionStats.total) *
                        100,
                    )
                  : 0}
                %
          ...
          <div className='flex items-center justify-between p-3 bg-yellow-50 border border-yellow-200 rounded-lg'>
            <div className='flex items-center space-x-3'>
              ...
              <span className='text-sm'>
                Payment failed for Silver subscription
              </span>
            </div>
