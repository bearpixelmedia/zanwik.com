      ...
      content: (
        <div className='space-y-4'>
          ...
          <ul className='space-y-2 text-gray-600'>
            <li>
              • <strong>Identify your business needs:</strong> What
              functionality do you need?
            </li>
            <li>
              • <strong>Check API documentation:</strong> Is it well-documented
              and easy to use?
            </li>
            <li>
              • <strong>Review pricing:</strong> Does it fit your budget and
              scale with your growth?
            </li>
            <li>
              • <strong>Test reliability:</strong> Use our health monitoring to
              check uptime
            </li>
            <li>
              • <strong>Consider support:</strong> Does the API provider offer
              good support?
            </li>
          </ul>
          <div className='bg-blue-50 p-4 rounded-lg'>
            <p className='text-sm text-blue-800'>
              <strong>Pro Tip:</strong> Start with free tiers to test APIs
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <Card className='p-4'>
              ...
              <p className='text-sm text-gray-600 mt-1'>
                Simple key-based authentication. Add your key to request
                headers.
              </p>
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-4'>
            <div>
              ...
              <p className='text-sm text-gray-600 mb-2'>
                Test your APIs before integration using our built-in testing
                tools:
              </p>
    ...
    <div className='max-w-6xl mx-auto px-4 py-8'>
      ...
      <Card className='p-8'>
        <div className='mb-6'>
          ...
          <p className='text-gray-600'>{steps[selectedStep].description}</p>
        </div>
        ...
        <div className='flex justify-between mt-8'>
          ...
          <Button
            onClick={() =>
              setSelectedStep(Math.min(steps.length - 1, selectedStep + 1))
            }
