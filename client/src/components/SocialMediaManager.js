  ...
  const mockCampaigns = [
    {
      ...
      platform: 'twitter',
      content:
        '🚀 Discover 1000+ APIs in our comprehensive directory! Perfect for developers and entrepreneurs. #API #DeveloperTools #Tech',
    ...
    },
    {
      ...
      platform: 'linkedin',
      content:
        "Building a startup? Check out our curated list of essential APIs that can accelerate your development process. From payment processing to AI services, we've got you covered.",
    ...
    },
    {
      ...
      platform: 'facebook',
      content:
        'New blog post: "The Complete Guide to API Integration for Entrepreneurs" - Learn how to integrate APIs into your business applications with our comprehensive guide.',
    ...
    },
    {
      ...
      platform: 'instagram',
      content:
        'Swipe through to see our top 5 APIs every developer should know! 🔥 #API #Developer #Tech #Programming',
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
            ...
            <div className='text-center'>
              <div className='text-3xl font-bold text-green-600'>
                {filteredCampaigns.reduce(
                  (sum, c) =>
                    sum + (c.engagement.retweets || c.engagement.shares),
                  0,
                )}
              </div>
            ...
            <div className='text-center'>
              <div className='text-3xl font-bold text-purple-600'>
                {filteredCampaigns.reduce(
                  (sum, c) =>
                    sum + (c.engagement.replies || c.engagement.comments),
                  0,
                )}
              </div>
