...
const App = () => {
  useEffect(() => {
    ...
    window.location.href = 'https://zanwik.com';
  }, []);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-background via-background to-muted">
      <div className="text-center space-y-6">
        ...
        <h1 className="text-4xl font-bold text-foreground mb-2">Redirecting...</h1>
        <p className="text-lg text-muted-foreground mb-4">Taking you to the main Zanwik API Directory.<br />If you're not redirected automatically, <a href="https://zanwik.com" className="underline text-primary">click here</a>.</p>
        <div className="mt-6">
