  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-background via-background to-muted">
      <div className="text-center space-y-6">
        ...
        <p className="text-lg text-muted-foreground mb-4">Taking you to the main Zanwik API Directory.<br />If you're not redirected automatically, <a href="https://money-19sseidup-byronmccluney.vercel.app" className="underline text-primary">click here</a>.</p>
        <div className="mt-6">
