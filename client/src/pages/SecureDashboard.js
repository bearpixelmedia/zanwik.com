          ...
          recentActivity: [
            {
              id: 1,
              type: 'api_added',
              message: 'Stripe API added to directory',
            ...
            },
            {
              ...
              message: 'New business project created',
              timestamp: '12 minutes ago',
            },
            {
              id: 4,
              type: 'api_tested',
              message: 'GitHub API health check completed',
    ...
    >
      ...
      >
        <div>
          ...
          <p
            style={{ color: '#a1a1aa', fontSize: '14px', margin: '4px 0 0 0' }}
          >
