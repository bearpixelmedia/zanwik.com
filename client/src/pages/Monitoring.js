      ...
      try {
        ...
        if (performance && performance.metrics) {
          setMetrics([
            {
              name: 'Response Time',
              value: performance.metrics.responseTime || 'N/A',
              change: '+12ms',
              trend: 'up',
            },
            {
              name: 'Error Rate',
              value: performance.metrics.errorRate || 'N/A',
              change: '-0.1%',
              trend: 'down',
            },
            {
              name: 'Throughput',
              value: performance.metrics.throughput || 'N/A',
              change: '+150',
              trend: 'up',
            },
            {
              name: 'Uptime',
              value: performance.metrics.uptime || 'N/A',
              change: '+0.1%',
              trend: 'up',
            },
          ]);
