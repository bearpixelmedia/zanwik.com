      ...
      <div className='container mx-auto px-4 py-8'>
          ...
          <div className='flex items-center space-x-4 mb-4'>
            ...
            <div>
              ...
              <p className='text-muted-foreground'>
                Test any API endpoint with our powerful testing interface. Send
                requests, view responses, and debug issues in real-time.
              </p>
              {api && (
                <div className='mt-2'>
            ...
            {response ? (
              ...
              <div className='text-center py-8 text-muted-foreground'>
                ...
                <p className='text-sm mt-2'>
                  This will make actual HTTP requests to the specified endpoint
                </p>
              </div>
            )}
          </Card>
        ...
        <div className='mt-8'>
          ...
          <div className='flex space-x-4'>
            <Button variant='outline' onClick={() => navigate('/apis/tools')}>
              ← Back to Tools
            </Button>
