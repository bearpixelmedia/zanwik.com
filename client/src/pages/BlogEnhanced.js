  ...
  useEffect(() => {
    ...
    const mockPosts = [
      ...
      },
      {
        ...
        excerpt:
          'Essential security practices for API development and integration. Learn how to protect your applications and user data.',
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      <Helmet>
        ...
        <meta
          name='description'
          content='Latest insights, tutorials, and best practices for API development. Learn from our comprehensive guides and expert tips.'
        />
        <script type='application/ld+json'>
          {JSON.stringify({
            ...
            description:
              'Latest insights, tutorials, and best practices for API development',
