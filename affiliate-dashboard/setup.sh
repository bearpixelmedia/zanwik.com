...
echo "🚀 Setting up Affiliate Marketing Dashboard..."
...
setup_database() {
    ...
    echo "2. Create a database named 'affiliate_dashboard'"
...
echo "🚀 Starting Affiliate Marketing Dashboard..."
...
echo "🏗️ Building Affiliate Marketing Dashboard for production..."
...
# Main setup function
main() {
    echo "📊 Affiliate Marketing Dashboard Setup"
    echo "====================================="
    echo ""
    ...
    echo "5. Run './start.sh' to start development servers"
    echo ""
